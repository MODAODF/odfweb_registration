...
use OCA\NdcRegistration\Db\RegistrationMapper;
...
class RegistrationService {
	 ...
	 * @param string $isimport
	 * @param string $group
	 * @param string $password
	 * @param string $displayname
	 * @return Registration
	 */
	public function createRegistration($email, $username="", $group="", $isimport=false, $password="", $displayname="") {
		$registration = new Registration();
		$registration->setEmail($email);
		$registration->setUsername($username);
		$registration->setDisplayname($displayname);
		$registration->setGroup($group);
		$registration->setIsImport($isimport);
		if ($password !== "") {
